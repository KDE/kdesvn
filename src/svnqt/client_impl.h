...
public:
     ...
     */
    StatusEntries status(const StatusParameter &params) throw (ClientException) override;
     ...
     */
    StatusPtr singleStatus(const Path &path, bool update = false, const Revision &revision = svn::Revision::HEAD) throw (ClientException) override;
     ...
     */
    Revision checkout(const CheckoutParameter &params) throw (ClientException) override;
    ...
    void relocate(const Path &path, const Url &from_url,
                  const Url &to_url, bool recurse, bool ignore_externals) throw (ClientException) override;
    ...
    remove(const Targets &targets,
           ...
           const PropertiesMap &revProps = PropertiesMap()) throw (ClientException) override;
    ...
    revert(const Targets &targets,
          ...
          ) throw (ClientException) override;
     ...
     * @sa svn::Depth
     */
    void add(const Path &path, svn::Depth depth, bool force = false, bool no_ignore = false, bool add_parents = true) throw (ClientException) override;
     ...
     * @exception ClientException
     */
    Revisions update(const UpdateParameter &params) throw (ClientException) override;
    ...
    cat(const Path &path,
        ...
        const Revision &peg_revision = Revision::UNDEFINED) throw (ClientException) override;
    /**
     * Retrieves the contents for a specific @a revision of
     * a @a path at @a peg_revision
     *
    ...
    cat(svn::stream::SvnStream &buffer,
        const Path &path,
        const Revision &revision,
        const Revision &peg_revision) throw (ClientException) override;
     ...
     */
    void annotate(AnnotatedFile &target, const AnnotateParameter &params) throw (ClientException) override;
     ...
     * @exception ClientException
     */
    svn::Revision commit(const CommitParameter &parameters) throw (ClientException) override;
    ...
    copy(const Path &srcPath,
         ...
         const Path &destPath) throw (ClientException) override;
    /**
     * Copies a versioned file with the history preserved.
     ...
     * @exception ClientException
     */
    svn::Revision copy(const CopyParameter &parameter) throw (ClientException) override;
     ...
     * @exception ClientException
     */
    svn::Revision move(const CopyParameter &parameter) throw (ClientException) override;
     ...
     * @exception ClientException
     */
    void cleanup(const Path &path) throw (ClientException) override;

    /**
     * Removes the 'conflicted' state on a file.
     * @exception ClientException
     */
    void resolve(const Path &path, Depth depth, const ConflictResult &resolution = ConflictResult()) throw (ClientException) override;
     ...
     */
    Revision doExport(const CheckoutParameter &params) throw (ClientException) override;
     ...
     */
    void merge(const MergeParameter &parameters) throw (ClientException) override;

    void merge_peg(const MergeParameter &parameters) throw (ClientException) override;
     ...
     * @sa LogParameter
     */
    bool log(const LogParameter &params, LogEntriesMap &target) throw (ClientException) override; 
    /**
     ...
     * @exception ClientException
     */
    QByteArray diff_peg(const DiffParameter &options) throw (ClientException) override;
     ...
     * @exception ClientException
     */
    QByteArray diff(const DiffParameter &options) throw (ClientException) override;
    ...
    list(const Path &pathOrUrl,
         const Revision &revision,
         const Revision &peg,
         svn::Depth depth, bool retrieve_locks) throw (ClientException) override;
    ...
    void lock(const Targets &targets, const QString &message,
              bool steal_lock) throw (ClientException) override;
    /**
    ...
    void unlock(const Targets &targets,
                bool break_lock) throw (ClientException) override;
