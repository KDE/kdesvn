...
IF (WIN32)
  ...
  ELSE (NOT APR_LIB)
    ...
    SET(SUBVESION_ALL_LIBS ${SUBVESION_ALL_LIBS} ${APR_LIB})
  endif(NOT APR_LIB)
  ...
  ELSE (NOT APRICONV_LIB)
    ...
    SET(SUBVESION_ALL_LIBS ${SUBVESION_ALL_LIBS} ${APRICONV_LIB})
  ...
  ELSE (NOT APU_LIB)
    ...
    SET(SUBVESION_ALL_LIBS ${SUBVESION_ALL_LIBS} ${APU_LIB})
  endif(NOT APU_LIB)
  ...
  ELSE (NOT APU_XMLLIB)
    ...
    SET(SUBVESION_ALL_LIBS ${SUBVESION_ALL_LIBS} ${APU_XMLLIB})
  ...
  ELSE (NOT NEON_LIB)
    ...
    SET(SUBVESION_ALL_LIBS ${SUBVESION_ALL_LIBS} ${NEON_LIB})
  endif(NOT NEON_LIB)
  ...
  ELSE (NOT APRICONV_LIB)
    ...
    SET(SUBVESION_ALL_LIBS ${SUBVESION_ALL_LIBS} ${NEON_ZLIBSTATLIB})
  ...
  ELSE (NOT DB43_LIB)
    ...
    SET(SUBVESION_ALL_LIBS ${SUBVESION_ALL_LIBS} ${DB43_LIB})
  endif(NOT DB43_LIB)
  ...
  ELSE (NOT SUBVERSION_DELTALIB)
    ...
    SET(SUBVESION_ALL_LIBS ${SUBVESION_ALL_LIBS} ${SUBVERSION_DELTALIB})
  ...
  ELSE (NOT SUBVERSION_DIFFLIB)
    ...
    SET(SUBVESION_ALL_LIBS ${SUBVESION_ALL_LIBS} ${SUBVERSION_DIFFLIB})
  ...
  ELSE (NOT SUBVERSION_FSBASELIB)
    ...
    SET(SUBVESION_ALL_LIBS ${SUBVESION_ALL_LIBS} ${SUBVERSION_FSBASELIB})
  ...
  ELSE (NOT SUBVERSION_FSFSLIB)
    ...
    SET(SUBVESION_ALL_LIBS ${SUBVESION_ALL_LIBS} ${SUBVERSION_FSFSLIB})
  ...
  ELSE (NOT SUBVERSION_RADAVLIB)
    ...
    SET(SUBVESION_ALL_LIBS ${SUBVESION_ALL_LIBS} ${SUBVERSION_RADAVLIB})
  ...
  ELSE (NOT SUBVERSION_RALOCALLIB)
    ...
    SET(SUBVESION_ALL_LIBS ${SUBVESION_ALL_LIBS} ${SUBVERSION_RALOCALLIB})
  ...
  ELSE (NOT SUBVERSION_RASVNLIB)
    ...
    SET(SUBVESION_ALL_LIBS ${SUBVESION_ALL_LIBS} ${SUBVERSION_RASVNLIB})
  ...
  ELSE (NOT SUBVERSION_INTL3LIB)
    ...
    SET(SUBVESION_ALL_LIBS ${SUBVESION_ALL_LIBS} ${SUBVERSION_INTL3LIB})
